        ...
        <nav className="w-full py-[2rem]">
            <div className="nav-wrapper flex flex-row items-center text-white justify-between">
                ...
                <div className="flex flex-row gap-10 items-center justify-center">
                    <Link href='/' className="hidden md:inline tracking-widest leading-snug">Options products</Link>
                    <Link href='/' className="hidden md:inline tracking-widest leading-snug">Why Nexo</Link>
                    <Link
                        href="/"
